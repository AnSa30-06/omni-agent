...
**[⬇ Download OmniAgentSetup-1.1.7.exe](https://github.com/AnSa30-06/omni-agent/releases/download/v1.1.7/OmniAgentSetup-1.1.7.exe)** — 74.6 MB, Windows 10/11 (64-bit)

That link always gives you version 1.1.7. The
...
```
7032438621BDB995A1EE22D3D6497D85B5FD5D43EDDEFA425C2361DEA79EA889
```
...
**[⬇ Download OmniAgent-Portable-1.1.7.zip](https://github.com/AnSa30-06/omni-agent/releases/download/v1.1.7/OmniAgent-Portable-1.1.7.zip)** — 123.3 MB
...
Its SHA-256 is `bbeb38ab001b8c16694146dda6bcecb431fd25f4100d6d930062cbf9921ddf5e`.
